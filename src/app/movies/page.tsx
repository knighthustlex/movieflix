      ...
      {loading ? (
        ...
        <>
          ...
          <div className="flex justify-center gap-4 mt-12">
            {page > 1 && (
              <Link href={`/movies?page=${page - 1}`} className="px-6 py-2 bg-zinc-800 text-white rounded-lg hover:bg-zinc-700">
                Previous
              </Link>
            )}
            {hasNext && (
              <Link href={`/movies?page=${page + 1}`} className="px-6 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700">
                Next
              </Link>
            )}
          </div>
