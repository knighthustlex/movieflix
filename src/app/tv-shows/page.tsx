      ...
      {loading ? (
        ...
        <>
          ...
          <div className="flex justify-center gap-4 mt-12">
            {page > 1 && (
              <Link href={`/tv-shows?page=${page - 1}`} className="px-6 py-2 bg-zinc-800 text-white rounded-lg hover:bg-zinc-700">
                Previous
              </Link>
            )}
            {hasNext && (
              <Link href={`/tv-shows?page=${page + 1}`} className="px-6 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700">
                Next
              </Link>
            )}
          </div>
        ...
        <div className="text-center py-16">
          <h3 className="text-xl text-gray-400">No TV shows found</h3>
        </div>
      )}
    </>
  );
